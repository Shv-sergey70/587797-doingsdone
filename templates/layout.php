...
<footer class="main-footer">
    <div class="container">
        ...
        <?php if($user):?>
            <a href="add_task.php" class="main-footer__button button button--plus">Добавить задачу</a>
        <?php else:?>
            <a href="registration.php" class="main-footer__button button">Зарегистрироваться</a>
        <?php endif;?>
        ...
        ,</span>
            <a class="social__link social__link--instagram" href="https://www.instagram.com/shv_sergey/">Instagram
            ...
            <a class="social__link social__link--vkontakte" href="https://vk.com/shv.sergey">Вконтакте
        ...
        <div class="main-footer__developed-by">
            <a href="https://vk.com/shv.sergey" class="button">
                Разработано<br>Шершнев Сергей
            </a>
        </div>
    </div>
</footer>
